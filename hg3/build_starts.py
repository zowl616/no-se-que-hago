"""Composite typography overlays onto base stills with subtle ink-bleed.
Shot 1 base = real HG photo (01_real.png). Shots 2 + 3 base = AI stills (02.png, 03.png).
"""
...
def main():
    mapping = {"01": "01_real.png", "02": "02.png", "03": "03.png"}
    for n, src in mapping.items():
        bg = Image.open(STILLS / src).convert("RGBA")
